...
MODE: three kanban cards per issue (build, gate, finish) on board
yt-cleanup, see plans/2026-09-24-tiered-cards-amendment.md. Each finish
card overwrites this file on its PR branch before merging.
UPDATED: 2026-09-24
